...
- Added FR-SPD-002 speed ramping via keyframed time-remap curves: a validated, monotonic
  ...
  source bounds or timeline domain, render/audio/compound mapping through the curve,
  cache-key invalidation on keyframe edits, legacy-safe codec coverage, and discriminating
  golden frame/audio ramp and within-clip freeze fixtures.
